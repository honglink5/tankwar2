...
def main():
    ...
    # 敌军坦克出现动画
    appearance_image = pygame.image.load(r".\image\appear.png").convert_alpha()     #坦克出现闪烁动画
    appearance = []
    ...
    while True:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if event.key == pygame.K_e:     # 升级
                    myTank_T1.levelUp()
                if event.key == pygame.K_q:     # 降级
                    myTank_T1.levelDown()
                if event.key == pygame.K_3:     # 3级
                    myTank_T1.levelUp()
                    myTank_T1.levelUp()
                    myTank_T1.level = 3
